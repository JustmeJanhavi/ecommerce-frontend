...
const AddOrder = () => {
  ...
  useEffect(() => {
    ...
    const fetchCustomers = async () => {
      try {
        const res = await axios.get(`${process.env.REACT_APP_API_URL}/orders/customers_orders`, {
          params: { storeId }
        });
    ...
    const fetchProducts = async () => {
      try {
        const res = await axios.get(`${process.env.REACT_APP_API_URL}/orders/products`, {
          params: { storeId }
        });
